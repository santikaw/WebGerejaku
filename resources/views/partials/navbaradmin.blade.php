<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-primary text-white p-2">
  <div class="container-fluid">
    <a class="navbar-brand" style="padding: 8px; margin-right: 2rem;" href="/home">Admin Sinode GKJ</a>
          ...
          <ul class="navbar-nav ms-auto ">
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                ...
                <li><a class="dropdown-item" href="/beritaadmin">Umum</a></li>
                <li>
                  <hr class="dropdown-divider">
                </li>
              </ul>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                ...
                <li><a class="dropdown-item" href="/homeadmin">Kalender Liturgi</a></li>
